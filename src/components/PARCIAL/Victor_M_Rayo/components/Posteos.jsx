...
export default function Posteos({ handlerClick }) {
  {/*FIXME => 
    LAS PROPS NO DEBEN SER DECLARADAS CON LA PALABRA PROPS COMO EN LA LÍNEA 17.
    ESA PALABRA ESTÁ EMBEDIDA EN REACT Y DEBERÍA USARSE DE FORMA RESERVADA PARA RECIBIR VALORES, NO PARA ENVIARLOS.
 */}
  return (
    <div className='container'>
      {data.map(post => <Post props={post} key={post.id} handlerClick={handlerClick} />)}
    </div>
  )
}
{/*NOTE => 
